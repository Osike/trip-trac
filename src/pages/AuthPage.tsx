          ...
          {!otpSent ? (
            <>
              ...
              <form onSubmit={handleEmailSubmit} className="space-y-4">
                ...
                <Button type="submit" disabled={loading} className="w-full bg-gradient-primary hover:bg-gradient-primary/90 shadow-glow">
            ...
            <form onSubmit={handleOtpVerify} className="space-y-4">
              ...
              <Button type="submit" disabled={loading || otp.length !== 6} className="w-full bg-gradient-primary hover:bg-gradient-primary/90 shadow-glow">
